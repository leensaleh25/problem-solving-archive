...
enum enMainMenueOptions{ eQuickWithdraw = 1, eNormalWithdraw = 2, eDeposit = 3, eCheckBalance=4,eLogeout = 5 };
struct sClient
{
...
bool FindClientData(string AccountNumber, string PinCode, sClient& Client)
{
...
bool LoadClientInfo(string AccountNumber, string PinCode)
{
    ...
    if (FindClientData(AccountNumber, PinCode, CurrentClient))
        return true;
    else
        return false;
...
void PerfromMainMenueOption(enMainMenueOptions MenueOptions) 
{
    switch (MenueOptions)
    {
    case eQuickWithdraw:
...
void ShowMainMenue()
{
    ...
    cout << "\t[5] Logout.\n";
    cout << "===========================================\n";
    PerfromMainMenueOption((enMainMenueOptions)ReadTransactionsMenueOption());
}
