...
int main()
{
	...
	cout << "Vacation From: " << DayShortName(DayOfWeekOrder(DateFrom)) << " " << DateFrom.Day << "/" << DateFrom.Month << "/" << DateFrom.Year << endl;
	cout << "Vacation To: " << DayShortName(DayOfWeekOrder(DateTo)) << " " << DateTo.Day << "/" << DateTo.Month << "/" << DateTo.Year << endl;
	cout << "Vacation Dayes: " << CalculateVacationDays(DateFrom, DateTo);
	return 0;
}
